...
import styles from "assets/jss/lavelyio-pro/components/headerLinksStyle.js";
...
export default function HeaderLinks(props) {
  ...
  return (
    <List className={classes.list + " " + classes.mlAuto}>
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          dropdownList={[
            ...
            <a
              href="https://demos.creative-tim.com/lavelyio-pro/#/documentation/tutorial?ref=mkpr-navbar"
              target="_blank"
      ...
      <ListItem className={classes.listItem}>
        <Button
          href="https://www.creative-tim.com/product/lavelyio-pro?ref=mkpr-navbar"
